...
const Printer = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const [printType, setPrinType] = useState("");
    ...
    fd.append("numberOfCopies", numberOfCopies);
    ...
    const postHandler = async (e) => {
      e.preventDefault();
      try {
        const { data } = await axios.post(`${Baseurl}api/v1/printer`, fd, Auth);
        const msg = data.message;
        showMsg("Success", msg, "success");
        props.onHide();
        fetchHandler();
        ...
        <Modal.Body>
          <Form onSubmit={postHandler}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                type="text"
                onChange={(e) => setPrinType(e.target.value)}
              />
            </Form.Group>
            <Form.Group className="mb-3">
