                  ...
                  <tbody>
                    {data?.map((i, index) => (
                      <tr key={index}>
                        <td> #{index + 1} </td>
                        <td> {i._id} </td>
                        <td>  <i className="fa-solid fa-indian-rupee-sign"></i>{i.totalAmount} </td>
                        <td> {i.status} </td>
                        <td> {i.paymentMethod} </td>
                        <td> <i className="fa-solid fa-indian-rupee-sign"></i>{i.shipping} </td>
                        <td> <i class="fa-solid fa-indian-rupee-sign"></i> {i.tax} </td>
                        <td>
