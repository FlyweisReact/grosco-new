...
const Nutrition = () => {
    ...
    const postHandler = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          "https://shahina-backend.vercel.app/api/v1/admin/Nutrition/addNutrition",
          fd,
          Auth
        );
    ...
    const putHandler = async (e) => {
      ...
      try {
        const { data } = await axios.put(
          `https://shahina-backend.vercel.app/api/v1/admin/Nutrition/updateNutrition/${id}`,
          fd,
          Auth
        );
        toast.success(data.message);
  ...
  const handleDelete = async (ide) => {
    const url = `https://shahina-backend.vercel.app/api/v1/admin/Nutrition/deleteNutrition/${ide}`;
    try {
