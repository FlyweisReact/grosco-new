...
const Brand = () => {
    ...
    const postHandler = async (e) => {
      ...
      try {
        const { data } = await axios.post(
          "https://shahina-backend.vercel.app/api/v1/admin/Brand/addBrand",
          fd,
          Auth
        );
    ...
    const putHandler = async (e) => {
      ...
      try {
        const { data } = await axios.put(
          `https://shahina-backend.vercel.app/api/v1/admin/Brand/updateBrand/${id}`,
          fd,
          Auth
        );
        toast.success(data.message);
  ...
  const handleDelete = async (ide) => {
    const url = `https://shahina-backend.vercel.app/api/v1/admin/Brand/deleteBrand/${ide}`;
    try {
    ...
    <>
      ...
      <section>
        <section className="sectionCont">
          ...
          {data?.length === 0 || !data ? (
            <NoData
              message={"It seems we don't have FAQs available at the moment"}
            />
          ) : (
            <>
