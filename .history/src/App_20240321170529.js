...
import VendorOrder from "./Vendor/pages/Orders/VendorOrder";
import VendorSingleOrder from "./Vendor/pages/Orders/VendorSingleOrder";
import VendorDriver from "./Vendor/pages/VendorDriver";
import VendorPrinter from "./Vendor/pages/VendorPrinter";
import VendorSupport from "./Vendor/pages/VendorSupport";
import VendorBrands from "./Vendor/pages/VendorBrands";
import VendorShift from "./Vendor/pages/VendorShift";
import VendorArea from "./Vendor/pages/VendorArea";
import VendorTime from "./Vendor/pages/VendorTime";
import Stores from "./E-CommerceAdmin/pages/Stores";
import AddStore from "./Vendor/pages/AddStore";
...
function App() {
  const routesData = [
    ...
    { path: "/vendor_Orders", element: <VendorOrder /> },
    { path: "/vendor_Orders/:id", element: <VendorSingleOrder /> },
    { path: "/vendor_drivers", element: <VendorDriver /> },
    { path: "/vendor_printer", element: <VendorPrinter /> },
    { path: "/vendor_support", element: <VendorSupport /> },
    { path: "/vendor_Brands", element: <VendorBrands /> },
    { path: "/vendor_shift", element: <VendorShift /> },
    { path: "/vendor_area", element: <VendorArea /> },
    { path: "/vendor_time", element: <VendorTime /> },
    { path: "/add_store", element: <AddStore /> },
  ];
