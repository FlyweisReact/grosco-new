...
import NoData from "../../../E-CommerceAdmin/pages/Component/NoData";
    ...
    <>
      <section className="sectionCont">
        ...
        <div className="overFlowCont">
          {data?.length === 0 || !data ? (
            <NoData message={"No Product created yet !"} />
          ) : (
            <Table>
              <thead>
                <tr>
                  ...
                  <tr key={index}>
                    ...
                    <td>
                      <span className="flexCont">
                        <Link to={`/vendor_edit_product/${i._id}`}>
                          <i className="fa-solid fa-pen-to-square" />
                        </Link>
                        <Link to={`/vendor_view_product/${i._id}`}>
...
export default HOC(VendorProduct);
